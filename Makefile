...
sdk: stage
	...
	$(ECHO_NOTHING)for i in Alderis; do \
		...
		cp -ra $(THEOS_STAGING_DIR)/usr/lib/$$i.framework/{$$i,Headers,Modules} $(ALDERIS_SDK_DIR)/$$i.framework/; \
	...
	$(ECHO_NOTHING)rm -r $(THEOS_STAGING_DIR)/usr/lib/*.framework/{Headers,Modules}$(ECHO_END)
